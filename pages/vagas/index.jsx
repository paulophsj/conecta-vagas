...
export default function VagaIndexPage() {
    ...
    useEffect(() => {
        ...
        const localidadeParam = searchParams.get('localidade')

        const localidade = localidadeParam ? decodeURIComponent(localidadeParam) : '';
    ...
    return (
        <>
            ...
            <button
                ...
                className="md:hidden fixed bottom-25 right-7 z-40 p-3 bg-blue-500 hover:bg-blue-600 cursor-pointer text-white rounded-full shadow-lg"
            >
                            ...
                            <div className="mb-2">
                                ...
                                <section className="space-y-4">
                                    <div>
                                        ...
                                        <input type="text" defaultValue={filtros?.cargo} name="cargo" className="dark:bg-gray-700 w-full dark:border-gray-600 rounded-sm outline-1 p-1 outline-blue-500" />
                                    </div>
                                        ...
                                        <div className="flex flex-col gap-2">
                                            {
                                                showLocalidadeFiltro && <label className="flex gap-2 items-center dark:text-gray-300">
                                                    <input
                                                        type="text"
                                                        name="localidade"
                                                        className="dark:bg-gray-700 w-full dark:border-gray-600 rounded-sm outline-1 p-1 outline-blue-500"
