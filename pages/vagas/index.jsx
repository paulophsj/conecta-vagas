    ...
    return (
        <>
            ...
            <section className="container p-5 mx-auto flex flex-col md:flex-row gap-5 items-start">
                ...
                {
                    !isLoading &&
                    <div className={`bg-white dark:bg-gray-800 w-11/12 md:w-1/4 p-4 shadow-md rounded-sm border border-gray-200 dark:border-gray-700 max-md:fixed h-fit top-1/2 left-1/2 max-md:transform max-md:-translate-x-1/2 max-md:-translate-y-1/2 ${openModal ? "fixed inset-0 z-50 overflow-y-auto" : "hidden md:block"}`}>
                        <div className="flex flex-col h-full">
                            <div className="mb-2">
                                ...
                                <section className="space-y-4">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <p className="font-bold dark:text-gray-200" id="area">Área</p>
                                        <label className="flex gap-2 items-center dark:text-gray-300">
                                            <input type="checkbox" className="dark:bg-gray-700 dark:border-gray-600" />
                            ...
                            <footer className="mt-4 flex flex-col gap-3">
                                <button className="text-xs w-full justify-center cursor-pointer p-2 items-center rounded-sm text-white flex gap-3 bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700">
                ...
                <div className="w-full md:w-3/4">
                    <ListCard setIsLoading={() => setIsLoading()} />
                </div>
            </section>
        </>
    )
