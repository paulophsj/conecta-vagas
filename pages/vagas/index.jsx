    ...
    return (
        <>
            ...
            <section className="container p-5 mx-auto flex flex-col md:flex-row gap-5 items-start">
                ...
                <div className={`bg-white w-full md:w-1/4 p-4 shadow-md rounded-sm max-md:sticky top-5 ${openModal ? "fixed inset-0 z-50 overflow-y-auto" : "hidden md:block"}`}>
                    <div className="flex flex-col h-full">
                        ...
                        <footer className="mt-4 flex flex-col gap-3">
                            <button className="text-xs w-full justify-center cursor-pointer p-2 items-center rounded-sm text-white flex gap-3 bg-blue-400 hover:bg-blue-500">
                            ...
                            <button className="text-xs w-full justify-center cursor-pointer p-2 items-center rounded-sm text-white flex gap-3 bg-yellow-400 hover:bg-yellow-500">
