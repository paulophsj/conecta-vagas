                                ...
                                {/* Seção de Informações Profissionais */}
                                {
                                    isCandidato ?
                                        ...
                                        <div class="max-w-3xl mx-auto bg-white">
                                            <div class="space-y-8">
                                                <h2 class="text-lg font-semibold text-gray-800 mb-4">Informações Corporativas</h2>
                                                <div class="mb-6">
                                                ...
                                                <div class="mb-6">
                                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                        <div>
                                                            <label for="porteEmpresa" class="block text-gray-700 text-sm font-bold mb-2">Porte da Empresa</label>
                                                            <select
                                                                id="porteEmpresa"
                                                                name="porteEmpresa"
                                                ...
                                                <div class="mb-6">
                                                    <div class="grid grid-cols-1">
                                                        <div>
                                                            <label for="setorEmpresa" class="block text-gray-700 text-sm font-bold mb-2">Setor Principal</label>
                                                            <select
                                                                id="setorEmpresa"
                                                                name="setorEmpresa"
                                                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400"
