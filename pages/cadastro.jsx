...
export default function CadastroPage() {
  ...
  const formSubmitHandler = async (event) => {
    ...
    const todosEnderecos = logradouro.map((_, index) => ({
  ...
  const adicionarEndereco = () => {
    setEnderecos([...enderecos, { id: Date.now() }]);
  };
  ...
  const adicionarFormacao = () => {
    setFormacoesAcademicas([...formacoesAcademicas, { id: Date.now() }]);
  };

  const removerFormacao = (id) => {
    setFormacoesAcademicas(formacoesAcademicas.filter(formacao => formacao.id !== id));
  };
      ...
      <div className="flex justify-center p-4">
        <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-6xl">
          <form id="form" className="space-y-8" onSubmit={formSubmitHandler} autoComplete="off">
            <div className="">
              <h1 className="text-3xl font-bold text-center text-blue-400 dark:text-blue-500 mb-8">Cadastro de Usuário</h1>
              {/* Seletor de Perfil */}
              <div className="flex justify-center mb-10">
                <div className="inline-flex rounded-md shadow-sm">
                  <button
                    ...
                    className={`px-8 py-3 text-lg font-medium rounded-l-lg ${isCandidato ? 'bg-blue-400 dark:bg-blue-600 text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600'}`}
                  >
                    Sou Candidato
                  </button>
                  <button
                    ...
                    className={`px-8 py-3 text-lg font-medium rounded-r-lg ${!isCandidato ? 'bg-blue-400 dark:bg-blue-600 text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600'}`}
                  >
                    Sou Recrutador
                  </button>
                </div>
            ...
            <div className="">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="w-full">
                  <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">Informações Pessoais</h2>
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    <div className="mb-4">
                      <label htmlFor={isCandidato ? "cpf" : "cnpj"} className="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">
                    ...
                    <div className="mb-4">
                      <label htmlFor={isCandidato ? "nome" : "nomeEmpresa"} className="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">
                  ...
                  <div className="grid grid-cols-1 gap-4 border-b border-gray-200 dark:border-gray-700 pb-6">
                    <div className="mb-4">
                      ...
                      <div className="relative">
                        ...
                        <button
                          tabIndex={-1}
                          className={`cursor-pointer text-gray-700 dark:text-gray-300 absolute inset-y-0 right-0 px-3 flex items-center`}
                          type="button"
                    ...
                    <div className="mb-7">
                      <label
                        ...
                        className={`block ${password.length < 6 ? 'text-gray-400' : 'text-gray-700 dark:text-gray-300'} text-sm font-bold mb-2`}
                      >
                        Confirmar senha
                      </label>
                      <div className="relative">
                        <input
                          ...
                          className={`w-full px-3 py-2 ${password.length < 6 ? 'bg-gray-200 dark:bg-gray-700 opacity-50' : ''} border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 dark:bg-gray-700 dark:text-white`}
                        />
                        <button
                          tabIndex={-1}
                          className={`cursor-pointer ${password.length < 6 ? 'text-gray-400 pointer-events-none' : 'text-gray-700 dark:text-gray-300 pointer-events-all'} absolute inset-y-0 right-0 px-3 flex items-center`}
                          type="button"
                  ...
                  {isCandidato && (
                    <>
                      <button
                        type="button"
                        className="text-sm my-8 cursor-pointer bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-3 py-1 rounded hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors"
                        onClick={adicionarEndereco}
                      >
                        + Adicionar Endereço
                      </button>
                      {enderecos.map((endereco, index) => (
                        <div className="border-b border-gray-200 dark:border-gray-700 py-6" key={endereco.id}>
                          <div className="flex justify-between max-md:flex-col items-start mb-4">
                            <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200">Endereço {index + 1}</h2>
                            <button
                              type="button"
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="mb-4">
                              <label htmlFor={`cep-${endereco.id}`} className="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">
                                CEP
                              </label>
                              <IMaskInput
                                mask="00000-000"
                            ...
                            <div className="mb-4 md:col-span-2">
                              <label htmlFor={`logradouro-${endereco.id}`} className="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">
                                Logradouro
                              </label>
                              <IMaskInput
                                mask={/^[A-Za-zÀ-ÿ\s]*$/}
                            ...
                            <div className="mb-4">
                              <label htmlFor={`numero-${endereco.id}`} className="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">
                                Número
                              </label>
                              <IMaskInput
                                mask={/^\d+$/}
                            ...
                            <div className="mb-4">
                              <label htmlFor={`complemento-${endereco.id}`} className="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">
                                Complemento
                              </label>
                              <IMaskInput
                                type="text"
                ...
                {isCandidato ? (
                  <div className="space-y-8">
                    <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">Informações Profissionais</h2>
                    ...
                    <button
                      type="button"
                      className="text-sm bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-3 py-1 cursor-pointer rounded hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors"
                      onClick={adicionarFormacao}
                    >
                      + Adicionar Formação
                    </button>
                    {formacoesAcademicas.map((formacao, index) => (
                      <div className="border-b border-gray-200 dark:border-gray-700 py-6" key={formacao.id}>
                        <div className="flex justify-between mb-4 max-md:flex-col items-start">
                          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200">Formação Acadêmica {index + 1}</h2>
                          <button
                            type="button"
                        ...
                        <div className="grid grid-cols-1 gap-4">
                          <div className="mb-4">
                            <label htmlFor={`curso-${formacao.id}`} className="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">
                              Curso
                            </label>
                            <IMaskInput
                              mask={/^[A-Za-zÀ-ÿ\s]*$/}
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="mb-4">
                              <label htmlFor={`instituicao-${formacao.id}`} className="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">
                                Instituição
                              </label>
                              <IMaskInput
                                mask={/^[A-Za-zÀ-ÿ\s]*$/}
                            ...
                            <div className="mb-4">
                              <label htmlFor={`anoConclusao-${formacao.id}`} className="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">
                                Ano de Conclusão
                              </label>
                              <IMaskInput
                                mask="0000"
                                type="text"
                                id={`anoConclusao-${formacao.id}`}
                                name="anoConclusao"
                                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 dark:bg-gray-700 dark:text-white"
                                placeholder="AAAA"
                              />
                          ...
                          <div className="mb-4">
                            <label htmlFor={`nivelAcademico-${formacao.id}`} className="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">
                              Nível de Formação
                            </label>
                            <select
                              id={`nivelAcademico-${formacao.id}`}
                              name="nivelAcademico"
                              className="w-full px-3 py-[10] border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 dark:bg-gray-700 dark:text-white"
                              defaultValue=""
                            >
                  ...
                  <div className="max-w-3xl mx-auto">
                    <div className="space-y-8">
                      <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">Informações Corporativas</h2>
                      <div className="mb-6">
                      ...
                      <div className="mb-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            <div className="mb-4">
                              <label htmlFor="anoFundacao" className="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">
                                Ano de Fundação
                              </label>
                              <IMaskInput
                                mask="0000"
                      ...
                      <div className="mb-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            <label htmlFor="porteEmpresa" className="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">Porte da Empresa</label>
                            <select
                              id="porteEmpresa"
                              name="porteEmpresa"
                              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 dark:bg-gray-700 dark:text-white"
                          ...
                          <div>
                            <label htmlFor="numeroFuncionarios" className="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">Nº de Funcionários</label>
                            <IMaskInput
                              mask="num"
                              blocks={{
                                num: {
                      ...
                      <div className="mb-6">
                        <div className="grid grid-cols-1">
                          <div>
                            <label htmlFor="setorEmpresa" className="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">Setor Principal</label>
                            <select
                              id="setorEmpresa"
                              name="setorEmpresa"
                              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 dark:bg-gray-700 dark:text-white"
                      ...
                      <div className="mb-6">
                        <label htmlFor="descricaoEmpresa" className="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">
            ...
            <button
              type="submit"
              className={`w-full lg:w-1/2 mx-auto block cursor-pointer ${passwordsMatch && isValidusername ? 'bg-blue-400 dark:bg-blue-600 hover:bg-blue-500 dark:hover:bg-blue-700' : 'bg-gray-300 dark:bg-gray-600 pointer-events-none'} text-white py-2 px-4 rounded-md transition duration-200 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-50`}
          ...
          <div className="mt-4 text-center">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <Link href={{ pathname: '/' }} className="text-blue-400 dark:text-blue-500 hover:underline">
                Termos de Uso
              </Link>
            </p>
          </div>
