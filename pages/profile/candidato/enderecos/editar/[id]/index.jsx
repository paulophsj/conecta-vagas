...
import { findOneEndereco, updateEndereco } from "@/api/Candidato";

export default function EnderecoUpdate() {
  const router = useRouter();
  const { id } = router.query;

  const { user, fetchUser } = useUser();
  const [selectedEstado, setSelectedEstado] = useState(user?.enderecoEstado || null);
              ...
              <div className="grid grid-cols-1 gap-4">
                <div className="mb-4">
                  ...
                  <IMaskInput
                    ...
                    id="enderecoCep"
                    name="enderecoCep"
                    defaultValue={endereco.enderecoCep}
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    id="enderecoRua"
                    name="enderecoRua"
                    defaultValue={endereco.enderecoRua}
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 dark:bg-gray-700 dark:text-white"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="mb-4">
                    ...
                    <IMaskInput
                      ...
                      id="enderecoNumero"
                      name="enderecoNumero"
                      defaultValue={endereco.enderecoNumero}
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 dark:bg-gray-700 dark:text-white"
                      placeholder="Número"
                      required
                    />
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      defaultValue={endereco.enderecoComplemento}
                      className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 dark:bg-gray-700 dark:text-white"
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    id="enderecoBairro"
                    name="enderecoBairro"
                    defaultValue={endereco.enderecoBairro}
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 dark:bg-gray-700 dark:text-white"
                    placeholder="Bairro"
                    required
                  />
              ...
              <div className="grid grid-cols-1 gap-4">
                <div className="flex flex-wrap justify-between gap-4">
                  <div className="w-full sm:w-5/12">
                    ...
                    <Estados
                      defaultValue={endereco.enderecoEstado}
                  ...
                  <div className="w-full sm:w-6/12">
                    ...
                    <Cidades
                      defaultValue={endereco.enderecoCidade}
