    ...
    return (
        <>
            <section className="container mx-auto p-15 max-sm:p-10 flex flex-col items-center gap-10">
                <h1 className="text-center text-5xl max-lg:text-4xl text-blue-400 dark:text-white font-bold">
                ...
                <form className="w-4xl flex justify-center gap-2 max-sm:flex-col max-sm:w-full max-lg:w-full">
                    <div className="w-full flex gap-2">
                        <input type="text" className="shadow-sm shadow-blue-400 placeholder:text-sm w-full max-sm:h-10 placeholder:text-blue-400 dark:placeholder:text-white p-2 max-sm:pl-3 focus:outline-1 focus:outline-blue-400 rounded-sm placeholder:text-center h-full" placeholder="O que você procura?(ex.: vendedor, TI...)" />
                        <div className="w-full relative hidden md:block">
                            ...
                            autoComplete="off"
                            className="max-sm:hidden shadow-sm shadow-blue-400 placeholder:text-sm w-full max-sm:h-10 placeholder:text-blue-400 dark:placeholder:text-white p-2 focus:outline-1 focus:outline-blue-400 rounded-sm placeholder:text-center h-full"
                    ...
                    <button className="bg-blue-400 max-sm:h-10 p-5 rounded-sm flex items-center justify-center gap-4 hover:bg-blue-500 cursor-pointer">
            ...
            <section className="container mb-10 mx-auto sm:px-6 lg:px-6">
                <h2 className="text-blue-400 dark:text-white text-2xl mb-10 font-bold text-center sm:text-left sm:text-3xl">Vagas em destaque</h2>
                <ListCard quantidade={4} />
            </section>
            <section className="container mx-auto sm:px-6 lg:px-8 mb-10">
                <h2 className="text-blue-400 dark:text-white text-2xl mb-10 font-bold text-center sm:text-left sm:text-3xl">Como funciona?</h2>
                <ul className="flex justify-center flex-wrap items-center gap-10 sm:justify-around">
                    <li className="w-40 h-40 flex flex-col items-center justify-center gap-2">
                        ...
                        <p className="text-blue-400 dark:text-white font-semibold text-center">1. Cadastre-se</p>
                    </li>
                    <li className="w-40 h-40 flex flex-col items-center justify-center gap-2">
                        ...
                        <p className="text-blue-400 dark:text-white font-semibold text-center">2. Envie seu currículo</p>
                    </li>
                    <li className="w-40 h-40 flex flex-col items-center justify-center gap-2">
                        ...
                        <p className="text-blue-400 dark:text-white font-semibold text-center">3. Candidate-se com um clique</p>
                    </li>
                </ul>
            </section>
            <section className="container mb-10 mx-auto px-4 sm:px-6 lg:px-8">
                <h2 className="text-blue-400 dark:text-white text-2xl mb-10 font-bold text-center sm:text-left sm:text-3xl">Comentários</h2>
