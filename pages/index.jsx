            ...
            <section className="container mx-auto h-80 p-10 flex flex-col items-center gap-10">
                ...
                <form action="" className="w-4xl flex justify-center gap-2 max-sm:flex-col max-sm:w-full max-lg:w-full">
                    <div className="w-full flex gap-2">
                        <input type="text" className="border-1 border-blue-400 placeholder:text-sm w-full max-sm:h-10 placeholder:text-blue-900 p-2 max-sm:pl-3 focus:outline-1 focus:outline-blue-400 rounded-sm placeholder:text-center h-full" placeholder="O que você procura?(ex.: vendedor, TI...)" />
                        <input type="text" className="max-sm:hidden border-1 border-blue-400 placeholder:text-sm w-full max-sm:h-10 placeholder:text-blue-900 p-2 focus:outline-1 focus:outline-blue-400 rounded-sm placeholder:text-center h-full" placeholder="Localização (Cidade/Estado)"/>
