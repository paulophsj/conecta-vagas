                        ...
                        <section className="p-4 flex flex-col items-start gap-5">
                            <aside className="flex gap-5 md:flex-col">
                                <div className="flex gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="oklch(70.5% 0.213 47.604)" className="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                                        <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6" />
                                    </svg>
                                    <p>{localidade}</p>
                                </div>
                                <div className="flex gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="oklch(70.5% 0.213 47.604)" class="bi bi-calendar" viewBox="0 0 16 16">
