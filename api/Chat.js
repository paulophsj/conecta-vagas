...
export const createChat = async (idCandidato) => {
    try {
        ...
        const response = await Fetch(`http://10.195.107.67:8080/api/chat`, {
            method: "POST",
...
export const findAllUserChats = async () => {
    try {
        ...
        const response = await Fetch(`http://10.195.107.67:8080/api/chat/${type}`, {
            method: "GET"
        })
...
export const findOneChat = async (idChat) => {
    try {
        const response = await Fetch(`http://10.195.107.67:8080/api/chat/${idChat}`, {
            method: "GET"
        })
