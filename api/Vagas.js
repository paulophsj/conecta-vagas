...
export const findAllVagas = async () => {
    try {
        const response = await fetch("http://192.168.15.127:8080/api/vagas", {
            method: "GET"
        })
...
export const findOneVaga = async (id) => {
    try {
        const response = await fetch(`http://192.168.15.127:8080/api/vagas/${id}`, {
            method: "GET"
        })
...
export const findAllVagasByRecrutador = async () => {
    try {
        const response = await Fetch(`http://192.168.15.127:8080/api/vagas/recrutador`, {
            method: "GET"
        })
